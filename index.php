...
<body class="bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100 min-h-screen font-sans flex flex-col selection:bg-indigo-500/30 selection:text-indigo-200">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400">Email Deliverability & DNS Diagnostics</p>
                </div>
            </div>
            <div class="flex items-center space-x-4">
                <span class="hidden md:inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-slate-800 text-slate-300 border border-slate-700">
                    PHP 8.2 + ES6
                </span>
    ...
    <main class="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col space-y-8">
        ...
        <section class="backdrop-blur-md bg-slate-900/60 border border-slate-800/80 shadow-2xl rounded-3xl p-6 sm:p-8 max-w-4xl mx-auto w-full transition-all duration-300">
            <form id="checkerForm" class="space-y-6">
                    ...
                    <div class="md:col-span-2 space-y-2">
                        ...
                        <div class="relative rounded-xl shadow-sm">
                            ...
                            <input type="text" name="domain" id="domainInput" required autocomplete="off"
                                   class="block w-full pl-11 pr-4 py-3.5 bg-slate-950/80 border border-slate-800 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all font-medium text-base shadow-inner"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative rounded-xl shadow-sm">
                            ...
                            <input type="text" name="selector" id="selectorInput" autocomplete="off"
                                   class="block w-full pl-11 pr-4 py-3.5 bg-slate-950/80 border border-slate-800 rounded-xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all font-medium text-base"
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-2">
                    ...
                    <div class="space-y-1.5">
                        <span class="block text-xs font-semibold text-slate-400 uppercase tracking-wider">Try Demo Presets</span>
                        <div class="flex flex-wrap gap-2">
                            <button type="button" onclick="loadPreset('demo-perfect.com')" class="px-3 py-1.5 rounded-lg text-xs font-medium border border-emerald-500/20 bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 hover:border-emerald-500/30 transition-colors">
                                Clean Pass (100%)
                            </button>
                            <button type="button" onclick="loadPreset('demo-warning.org')" class="px-3 py-1.5 rounded-lg text-xs font-medium border border-amber-500/20 bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 hover:border-amber-500/30 transition-colors">
                                Warnings (60%)
                            </button>
                            <button type="button" onclick="loadPreset('demo-critical.net')" class="px-3 py-1.5 rounded-lg text-xs font-medium border border-rose-500/20 bg-rose-500/10 text-rose-400 hover:bg-rose-500/20 hover:border-rose-500/30 transition-colors">
                                Critical Issues (20%)
                            </button>
                        </div>
                    </div>
        ...
        <div id="errorAlert" class="max-w-4xl mx-auto w-full hidden border border-rose-500/20 bg-rose-500/10 text-rose-400 px-5 py-4 rounded-2xl flex items-start space-x-3">
            <svg class="h-6 w-6 flex-shrink-0 mt-0.5 text-rose-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div id="resultDashboard" class="space-y-8 opacity-0 pointer-events-none transition-all duration-700 transform translate-y-4 max-w-6xl mx-auto w-full">
            
            <!-- Diagnostics Header card -->
            <section class="backdrop-blur-md bg-slate-900/60 border border-slate-800/80 rounded-3xl p-6 sm:p-8 shadow-2xl flex flex-col md:flex-row items-center gap-8 justify-between relative overflow-hidden">
                ...
                <div class="space-y-4 text-center md:text-left flex-grow">
                    ...
                    <div class="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-2">
                        <div class="flex items-center space-x-2 px-3 py-1.5 rounded-xl bg-slate-950 border border-slate-800">
                            <span class="text-slate-400 text-xs uppercase font-semibold">MX</span>
                            <span id="badgeMX" class="h-2.5 w-2.5 rounded-full bg-slate-700"></span>
                        </div>
                        <div class="flex items-center space-x-2 px-3 py-1.5 rounded-xl bg-slate-950 border border-slate-800">
                            <span class="text-slate-400 text-xs uppercase font-semibold">SPF</span>
                            <span id="badgeSPF" class="h-2.5 w-2.5 rounded-full bg-slate-700"></span>
                        </div>
                        <div class="flex items-center space-x-2 px-3 py-1.5 rounded-xl bg-slate-950 border border-slate-800">
                            <span class="text-slate-400 text-xs uppercase font-semibold">DMARC</span>
                            <span id="badgeDMARC" class="h-2.5 w-2.5 rounded-full bg-slate-700"></span>
                        </div>
                        <div class="flex items-center space-x-2 px-3 py-1.5 rounded-xl bg-slate-950 border border-slate-800">
                            <span class="text-slate-400 text-xs uppercase font-semibold">DKIM</span>
                            <span id="badgeDKIM" class="h-2.5 w-2.5 rounded-full bg-slate-700"></span>
                        </div>
                        <div class="flex items-center space-x-2 px-3 py-1.5 rounded-xl bg-slate-950 border border-slate-800">
                            <span class="text-slate-400 text-xs uppercase font-semibold">SSL</span>
            ...
            <section class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <!-- MX Panel -->
                <div class="backdrop-blur-md bg-slate-900/60 border border-slate-800/80 rounded-3xl p-6 shadow-xl flex flex-col justify-between">
                    <div class="space-y-4">
                        ...
                        <p id="msgMX" class="text-sm text-slate-300">Checking MX record configuration...</p>
                        
                        <!-- List container -->
                        <div class="space-y-2">
                            <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider">Configured Servers</label>
                            <div id="listMX" class="bg-slate-950/80 border border-slate-850 rounded-xl p-3 text-xs font-mono space-y-1.5 max-h-[140px] overflow-y-auto">
                    ...
                    <div class="mt-6 border-l-2 border-indigo-500/50 bg-indigo-500/5 px-4 py-3 rounded-r-xl space-y-1">
                        <span class="text-xs font-bold uppercase tracking-wider text-indigo-400 flex items-center space-x-1">
                            <svg class="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                            <span>Support Guidance</span>
                        </span>
                        <p id="tipMX" class="text-xs text-slate-300 leading-relaxed">Reading recommendations...</p>
                    </div>
                </div>
                ...
                <div class="backdrop-blur-md bg-slate-900/60 border border-slate-800/80 rounded-3xl p-6 shadow-xl flex flex-col justify-between">
                    <div class="space-y-4">
                        ...
                        <p id="msgSPF" class="text-sm text-slate-300">Checking SPF record details...</p>

                        <!-- SPF Record box -->
                        <div class="space-y-2">
                            <div class="flex items-center justify-between">
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider">Raw TXT Record</label>
                                <button type="button" onclick="copyRecordText('recordValSPF')" class="text-slate-500 hover:text-slate-300 text-xs transition-colors flex items-center space-x-1">
                            ...
                            <div id="recordValSPF" class="bg-slate-950/80 border border-slate-850 rounded-xl p-3 text-xs font-mono break-all text-slate-300 min-h-[50px] flex items-center">
                    ...
                    <div class="mt-6 border-l-2 border-indigo-500/50 bg-indigo-500/5 px-4 py-3 rounded-r-xl space-y-1">
                        ...
                        <p id="tipSPF" class="text-xs text-slate-300 leading-relaxed">Reading recommendations...</p>
                    </div>
                </div>
                ...
                <div class="backdrop-blur-md bg-slate-900/60 border border-slate-800/80 rounded-3xl p-6 shadow-xl flex flex-col justify-between">
                    <div class="space-y-4">
                        ...
                        <p id="msgDMARC" class="text-sm text-slate-300">Checking DMARC rules...</p>

                        <!-- DMARC Record box -->
                        <div class="space-y-2">
                            <div class="flex items-center justify-between">
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider">Raw TXT Record</label>
                                <button type="button" onclick="copyRecordText('recordValDMARC')" class="text-slate-500 hover:text-slate-300 text-xs transition-colors flex items-center space-x-1">
                                    <svg class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m0 0h2a2 2 0 012 2v3m2 4H10m0 0l3-3m-3 3l3 3" /></svg>
                                    <span>Copy Record</span>
                                </button>
                            </div>
                            <div id="recordValDMARC" class="bg-slate-950/80 border border-slate-850 rounded-xl p-3 text-xs font-mono break-all text-slate-300 min-h-[50px] flex items-center">
                    ...
                    <div class="mt-6 border-l-2 border-indigo-500/50 bg-indigo-500/5 px-4 py-3 rounded-r-xl space-y-1">
                        ...
                        <p id="tipDMARC" class="text-xs text-slate-300 leading-relaxed">Reading recommendations...</p>
                    </div>
                </div>
                ...
                <div class="backdrop-blur-md bg-slate-900/60 border border-slate-800/80 rounded-3xl p-6 shadow-xl flex flex-col justify-between">
                    <div class="space-y-4">
                        ...
                        <p id="msgDKIM" class="text-sm text-slate-300">Checking DKIM parameters...</p>
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2">
                                    <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider">Raw TXT Record</label>
                                    <span id="badgeSelectorUsed" class="px-2 py-0.5 rounded-md text-[10px] font-bold bg-slate-850 text-slate-300 border border-slate-800">selector: none</span>
                                </div>
                                <button type="button" onclick="copyRecordText('recordValDKIM')" class="text-slate-500 hover:text-slate-300 text-xs transition-colors flex items-center space-x-1">
                                    <svg class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m0 0h2a2 2 0 012 2v3m2 4H10m0 0l3-3m-3 3l3 3" /></svg>
                                    <span>Copy Record</span>
                                </button>
                            </div>
                            <div id="recordValDKIM" class="bg-slate-950/80 border border-slate-850 rounded-xl p-3 text-xs font-mono break-all text-slate-300 min-h-[50px] max-h-[120px] overflow-y-auto flex items-center">
                    ...
                    <div class="mt-6 border-l-2 border-indigo-500/50 bg-indigo-500/5 px-4 py-3 rounded-r-xl space-y-1">
                        ...
                        <p id="tipDKIM" class="text-xs text-slate-300 leading-relaxed">Reading recommendations...</p>
                    </div>
                </div>

                <!-- SSL Panel -->
                <div class="backdrop-blur-md bg-slate-900/60 border border-slate-800/80 rounded-3xl p-6 shadow-xl flex flex-col justify-between lg:col-span-2">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            ...
                            <p id="msgSSL" class="text-sm text-slate-300">Checking SSL endpoint...</p>

                            <!-- Certificate Details list -->
                            <div class="space-y-2">
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider">Certificate Metadata</label>
                                <div class="bg-slate-950/80 border border-slate-850 rounded-xl p-3 text-xs font-mono space-y-1.5">
                        ...
                        <div class="flex flex-col justify-end">
                            <div class="border-l-2 border-indigo-500/50 bg-indigo-500/5 px-4 py-3 rounded-r-xl space-y-1 h-fit md:mb-0">
                                ...
                                <p id="tipSSL" class="text-xs text-slate-300 leading-relaxed">Reading recommendations...</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="backdrop-blur-md bg-slate-900/60 border border-slate-800/80 rounded-3xl p-6 shadow-xl space-y-4">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-800/50 pb-4">
                    <div>
                        <h4 class="font-bold text-white text-base">Deliverability Assessment Summary</h4>
                        <p class="text-xs text-slate-400">Share findings or generate documentation templates for clients.</p>
                    </div>
                    <button type="button" onclick="copyFullReport()" class="px-4 py-2 bg-slate-850 hover:bg-slate-800 active:bg-slate-900 border border-slate-800 text-slate-200 hover:text-white font-medium rounded-xl text-xs transition-colors flex items-center space-x-1.5 shadow-sm">
                ...
                <div class="relative">
                    <textarea id="fullReportArea" readonly
                              class="w-full bg-slate-950/90 border border-slate-850 rounded-2xl p-4 text-xs font-mono text-slate-400 focus:outline-none focus:ring-0 min-h-[160px] leading-relaxed resize-none"></textarea>
                </div>
            </section>
    ...
    <!-- Footer -->
    <footer class="border-t border-slate-900 bg-slate-950 py-8 text-center text-xs text-slate-500 mt-12">
        <div class="max-w-7xl mx-auto px-4 space-y-3">
            ...
            <p class="flex items-center justify-center space-x-2 text-slate-600">
